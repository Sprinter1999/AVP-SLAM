...
'''
TODO: Robot Model: two wheels + around view cameras
Twist type of ROS:
    geometry_msgs/Vector3 linear, "3-dim vector"
    geometry_msgs/Vector3 angular, "3-dim vector"

Pose: x,y,theta

Noise control command:
    Once receiving Odometry "v" and "w" from /ideal_cmd_vel, they are disruped by Multi-variate Gaussian noise, noisy cmd are published to /cmd_vel for Gazebo simulation.
'''
...
def odom_callback(data):
    ...
    #TODO: noisy control command are generated by multi-variate Gaussian distribution
    # gazebo_c1~gazebo_c4 (1e-3) are pre-defined constants which helps to generate noise
